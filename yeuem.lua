...
print("⚙️ Layout 3 cột + 2 cột")
print("📏 3 slider: Phạm vi / Tốc độ bay / Tốc độ chạy")
print("═══════════════════════════════════════════")
