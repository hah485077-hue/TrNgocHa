...
local function forcePushEnemy(otherRoot, otherHum)
    ...
    --========================================
    -- LỚP 1: BodyPosition (đẩy tới vị trí mục tiêu)
    --========================================
...
--========================================
-- XÓA LỰC ĐẨY KHỎI KẺ ĐỊCH (KHI TẮT)
--========================================
...
--========================================
-- TẠO TƯỜNG VÔ HÌNH (2 LỚP - 72 PARTS)
--========================================
...
local function destroyField()
    ...
    -- Xóa lực đẩy khỏi kẻ địch trước
...
local function createMenu()
    ...
    resetBtn.MouseButton1Click:Connect(function()
        ...
        radiusFill.Size = s UDim2.new(15 / 30, 0, 1, 0)
    ...
    TweenService:Create(main, TweenInfo.newử(0.5, Enum.EasingStyle.Back, Enum.EasingDirectiona.Out), {
        Size = U |
Dim2.new(0, 280,|---|--- 0, 330)
    }):Play()
...
print("═══════════════════════════════════════════")
print("💜 PURPLE MAGNETIC FIELD v2.6 - LOADED!")
