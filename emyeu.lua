...
========================================
 ...
 Combined Edition v2.0 | Full Fixed
 By Em 💕
========================================
]]
...
minBtn.BackgroundColor3 = Color3.fromRGB(60, 40, 120)
minBtn.Text = "▼"
...
table.insert(ledElements, minBtn)
...
pcall(function()
    StarterGui:SetCore("SendNotification", {
        Title = "💜 VIP CYBER",
        Text = "Menu đã sẵn sàng! Chạm ▼ để thu nhỏ.",
        Duration = 5
    })
end)
...
print("✋ Kéo menu từ bất kỳ chỗ nào")
print("🔽 Chạm ▼ để thu nhỏ, ▲ để mở rộng")
print("❌ Chạm X để ẩn hoàn toàn (hiện nút VIP)")
print("═══════════════════════════════════════════")
